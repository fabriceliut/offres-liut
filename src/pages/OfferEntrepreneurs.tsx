...
const PAIN_POINTS = [
  "Votre entreprise avance sans dépendre de chacune de vos décisions.",
  "Votre temps repart vers la stratégie et le développement (fini les 70% en opérationnel).",
  "Une seule source de vérité : une vue d'ensemble en temps réel, plus d'infos éparpillées.",
  "Vous déléguez sereinement — vos équipes ont les bonnes infos pour avancer.",
  "Un reporting qui se tient à jour tout seul.",
];
...
const PROGRAM_STEPS = [
  { title: "Audit de votre pilotage", desc: "On cartographie votre réalité : comment circule l'info, où se cachent vos heures à récupérer, ce qui peut déjà tourner sans vous." },
  ...
  { title: "It\u00e9rations terrain", desc: "On ajuste selon l'usage réel. Ce qui marche, on garde. Ce qui peut être plus fluide, on l'allège. Le système s'adapte à vous, pas l'inverse." },
          ...
          <Container className="relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <motion.h1 custom={1} variants={fadeUp} initial="hidden" animate="visible" className="mb-5" style={{ color: 'var(--text)' }}>
                Pilotez votre PME depuis la hauteur
                <br />
                <span style={{ color: 'var(--primary)' }}>— pas depuis l'opérationnel.</span>
              </motion.h1>
              ...
              <motion.p custom={2} variants={fadeUp} initial="hidden" animate="visible" className="text-lg mb-4" style={{ color: 'var(--primary)', fontWeight: 600, fontFamily: 'var(--font-heading)' }}>
                {"Voici le système de pilotage que je mets en place pour les dirigeants qui veulent voir clair, décider vite et déléguer sereinement."}
              </motion.p>
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  { title: "Gestion de projets simplifi\u00e9e", desc: "Jalons et d\u00e9pendances : vous voyez d'un coup d'\u0153il ce qui avance et ce qui attend." },
              ...
              <div className="card-base p-6" style={{ background: 'var(--surface2)' }}>
                <div className="flex flex-col gap-4 mb-6">
                  ...
                  <div className="flex items-start gap-3 p-4 rounded-xl" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
                    <span style={{ fontSize: '1.1rem', flexShrink: 0 }}>{"📊"}</span>
                    <p style={{ fontSize: '0.875rem', color: 'var(--muted)', lineHeight: 1.7 }}>
                      <strong style={{ color: 'var(--text)' }}>{"Des décisions plus rapides."}</strong>{" Une décision prise une semaine plus tôt, c'est une opportunité saisie à temps."}
                    </p>
                  </div>
                  <div className="flex items-start gap-3 p-4 rounded-xl" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
                    <span style={{ fontSize: '1.1rem', flexShrink: 0 }}>{"🤝"}</span>
                    <p style={{ fontSize: '0.875rem', color: 'var(--muted)', lineHeight: 1.7 }}>
                      <strong style={{ color: 'var(--text)' }}>{"Votre entreprise tourne avec vous, pas seulement par vous."}</strong>{" Vos managers ont l'info, vos équipes avancent. Moins de sollicitations, moins d'allers-retours."}
                    </p>
                  </div>
                </div>
          ...
          <Container>
            ...
            >
              ...
              <p className="mb-8" style={{ color: 'var(--muted)', fontSize: '1rem', lineHeight: 1.7 }}>
                45 min pour comprendre votre situation. Vous me dites où vous voulez aller.
